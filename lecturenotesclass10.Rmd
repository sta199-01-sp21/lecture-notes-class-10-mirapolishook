...
Very close! Law if large numbers!
...
the square of dice roll 1 is equal to dice roll 2; or the absolute value of the difference between dice roll 1 and dice roll 2 is equal to 4.

Perform a simulation to compute this empirical probability.

Write down your guess to the answer before you calculate it.

My guess is that is is more likely that the absolute value of the difference between the two dice rolls is equal to 4. 
